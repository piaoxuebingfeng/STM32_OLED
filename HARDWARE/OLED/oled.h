...
//-----------------测试LED端口定义---------------- 
#define LED_ON GPIO_ResetBits(GPIOA,GPIO_Pin_12)//LED
...
#define OLED_DC_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_7)//DC
#define OLED_DC_Set() GPIO_SetBits(GPIOC,GPIO_Pin_7)
